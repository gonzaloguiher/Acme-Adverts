...
<security:authorize access="hasRole('MANAGER')">
	...
	<form:form action="infoFile/edit.do" modelAttribute="infoFile">

		<form:hidden path="id" />
		<form:hidden path="version"  />
		<form:hidden path="contract" />
		
		<acme:textbox code="file.title" path="title" />
		<acme:textbox code="file.text"  path="text"  /> <br/>
		
		<acme:submit code="file.save" name="save" />
		
		<jstl:if test="${infoFile.id != 0}">
