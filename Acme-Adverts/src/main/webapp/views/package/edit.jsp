...
<security:authorize access="hasRole('MANAGER')">
	...
	<form:form action="package/manager/edit.do" modelAttribute="pakage">
		...
		<!-- <acme:textbox code="package.startMoment" path="startMoment"/> <br/> -->
		...
		<jstl:if test="${pakage.id != 0}">
		<acme:checkbox code="package.isDraft" path="isDraft"/> <br />
		</jstl:if>
		
		<acme:submit code="package.save" name="save"/>
		
		<jstl:if test="${pakage.id != 0}">
		<acme:submit code="package.delete" name="delete"/>
		</jstl:if>
