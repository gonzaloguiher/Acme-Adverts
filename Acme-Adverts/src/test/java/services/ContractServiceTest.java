...
public class ContractServiceTest extends AbstractTest {
	...
	// Total coverage: 87.9%
	// Covered Instructions: 627
	//  Missed Instructions: 86
	//   Total Instructions: 713
	...
	public void testSaveIncorrectData() {
		...
		contract.setText("");
		contract.setHash("");
		contract.setSignCustomer("");
		contract.setSignManager("");
		contract.setMomentCustomer(momentCustomer);
		contract.setMomentManager(momentManager);
		contract.setPakage(pakage);
...
//	}
	...
	public void testDeleteIsFinal() {
		...
		Assert.isTrue(!contractService.findAll().contains(contract));
